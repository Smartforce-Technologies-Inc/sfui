...
const BreakpointsEnumBase = styled(
...
export const BreakpointsEnum: Story = () => <BreakpointsEnumBase />;

const SassVariablesBase = styled(
  ({ className }: React.HTMLAttributes<HTMLDivElement>) => (
    <div className={className}>
      <h2>Media Queries Breakpoints</h2>
...
export const SassVariables: Story = () => <SassVariablesBase />;
